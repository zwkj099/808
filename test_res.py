...
def test1(ip, port, mobile, deviceid, vnum, name, qualification,attach,filepath,i=0,tal=0):
   ...
   #上传wifi数据时，必须同时上传基站数据，上传基站数据，0200状态要为未定位
    ...
    wsid = [225]  # 上传的主动安全报警类型；0: 表示不带主动安全数据；81,82北京主动安全数据;225-231是中位主动安全数据，冀标只有100和101；100：驾驶辅助功能报警信息；101：驾驶员行为监测功能报警信息；112：激烈驾驶报警信息；102：轮胎状态监测报警信息；103：盲区监测报警信息；113：卫星定位系统报警信息；川冀标切换只需改端口；
