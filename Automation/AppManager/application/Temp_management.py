...
class temp_management(object):
    def __init__(self):
        pass
        #self.browser = webdriver.Firefox()
    def set_temp_parameter(self,calibration_data,browser,vnum,logfile,logtofile):
        
        self.browser = browser
        
        #温度监测id
        time.sleep(5)
        self.browser.find_element_by_id("32e16952-622b-11e7-907b-a6006ad3dba0").click()
        # 温度监测设置id
        time.sleep(3)
        self.browser.find_element_by_id("3d128dc4-622c-11e7-907b-a6006ad3dba0").click()
        time.sleep(5)
        # 搜索框输入桂A00002
...
#             logtofile(logfile,"sensor_data:"+str(data)+"\n")
    ...
    def send_temp_parameter(self,browser,logfile,logtofile):
        # 点击下发参数
        self.browser = browser        
